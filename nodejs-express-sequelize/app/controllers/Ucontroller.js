...
exports.create = (req, res) => {
   //client are sending data which include customer name, But we have to add customerId in user table
   //Therefore using findone function we are fetching customerId of that customerName from Customer Table
